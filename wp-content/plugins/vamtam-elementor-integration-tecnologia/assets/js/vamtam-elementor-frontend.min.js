! function($, undefined) {
    ...
    var VAMTAM_ELEMENTOR = {
        domLoaded: function() {
            this.VamtamMainNavHandler.init(), this.VamtamActionLinksHandler.init(), this.VamtamPopupsHandler.disablePopupAutoFocus(), elementorFrontend.config.experimentalFeatures.e_optimized_css_loading && this.VamtamImprovedCSSLoadingHandler.init()
        },
        pageLoaded: function() {
            this.VamtamPopupsHandler.init(), this.VamtamWidgetsHandler.stickyInsideParentFix()
        },
        VamtamPopupsHandler: {
            init: function() {
                this.searchFormPopupsGetFocus(), this.absolutelyPositionedPopups(), this.alignedWithSelectorPopups(), this.enablePageTransitionsForPopupLinks(), this.lateInit()
            },
            lateInit: function() {
                setTimeout(() => {
            ...
            searchFormPopupsGetFocus: function() {
                window.elementorFrontendConfig.kit.vamtam_theme_search_form_popups_get_focus && elementorFrontend.elements.$window.on("elementor/popup/show", event => {
            ...
            absolutelyPositionedPopups: function() {
                ...
                elementorFrontend.elements.$window.on("elementor/popup/show", event => {
                    ...
                    const id = event.originalEvent.detail.id,
                        instance = event.originalEvent.detail.instance;
                    if (!id || !instance || cache.includes(id)) return;
                    const isAbsPositioned = instance.$element.filter('[data-elementor-settings*="vamtam_abs_pos"]').length;
                    isAbsPositioned && (instance.$element.closest(`#elementor-popup-modal-${id}`).addClass("vamtam-abs-pos"), cache.push(id))
                })
            },
            alignedWithSelectorPopups: function() {
                ...
                }), window.removeEventListener("resize", resetCache), window.addEventListener("resize", resetCache, !0)
            },
            disablePopupAutoFocus: function() {
                elementorFrontend.elements.$window.on("elementor/popup/show elementor/popup/hide", event => {
                    setTimeout(() => {
                        "input" !== document.activeElement.nodeName && document.activeElement.blur()
                    }, 100)
                })
            },
            enablePageTransitionsForPopupLinks() {
                ...
                if (!$pageTransitionEl.length) return;
                ...
                onLinkClickHandler && jQuery(document).on("click", selector, onLinkClickHandler.bind($pageTransitionEl))
            },
            hoverActivatedPopups: function() {
                ...
                function getHoverActivatedPopupBySelector(selector) {
                    ...
                    let popupToReturn;
                    return hoverActivatedPopups.forEach(popup => {
                        popupToReturn || $selector.filter(popup.selector).length && (popupToReturn = popup)
                    }), popupToReturn
                }
                ...
                function getHoverActivatedPopupById(id) {
                    let popupToReturn;
                    return hoverActivatedPopups.forEach(popup => {
                        popupToReturn || popup.id === id && (popupToReturn = popup)
                    }), popupToReturn
                }

                function isValidMouseleave(el, context) {
                    return "open_selector" !== context || !jQuery(el).find("*:hover").length
                }
                popups.forEach(popup => {
                    ...
                    if (isHoverActivated) {
                        ...
                        hoverActivatedPopups.push({
                            ...
                            isHovering: !1,
                            selectorIsHovering: !1,
                            closeOnHoverLost: closeOnHoverLost,
                            modal: popup.instance.getModal(),
                            showPopup: function() {
                                this.instance.showModal(), "input" !== document.activeElement.nodeName && document.activeElement.blur()
                            },
                            hidePopup: function() {
                                this.modal.hide()
                            },
                ...
                }), hoverActivatedPopups.length && hoverActivatedPopups.forEach(popup => {
                    jQuery(popup.selector).on("mouseenter", (function() {
                        const popup = getHoverActivatedPopupBySelector(this);
                        popup && (popup.selectorIsHovering = !0, popup.isVisible() || popup.showPopup())
                        ...
                        if (Number.isInteger(pId)) {
                            ...
                            popup && (popup.isHovering = !0)
                        }
                    })), popup.closeOnHoverLost && (jQuery(popup.selector).on("mouseleave", (function() {
                        setTimeout(() => {
                            if (!isValidMouseleave(this, "open_selector")) return;
                            const popup = getHoverActivatedPopupBySelector(this);
                            popup && (popup.selectorIsHovering = !1, popup.isVisible() && !popup.isHovering && popup.hidePopup())
                        }, 200)
                        ...
                        setTimeout(() => {
                            ...
                            if (Number.isInteger(pId)) {
                                const popup = getHoverActivatedPopupById(pId);
                                popup && (popup.isHovering = !1, popup.selectorIsHovering || popup.hidePopup())
                            }
                        }, 200)
                    })))
                })
            ...
            utils: {
                getPopups: function() {
                    const docs = elementorFrontend.documentsManager.documents,
                        popups = [];
                    return Object.entries(docs).forEach(([docId, doc]) => {
                        doc.initModal && (doc.getModal || doc.initModal(), popups.push({
                            id: docId,
                            instance: doc
                        }))
                    }), popups
        ...
        VamtamMainNavHandler: {
            ...
            fixMenuDrodownScrolling: function() {
                var $mainMenuDropdown = $(".elementor-location-header .elementor-nav-menu--dropdown-tablet .elementor-nav-menu--dropdown.elementor-nav-menu__container").first(),
                    menuToggle = $mainMenuDropdown.siblings(".elementor-menu-toggle")[0];
                if ($mainMenuDropdown.length && menuToggle.length) {
                    var onMenuToggleClick = function() {
                        if ($(menuToggle).hasClass("elementor-active")) {
                            ...
                            $mainMenuDropdown.css("max-height", "calc(100vh - " + height + "px)"), menuToggle.removeEventListener("click", onMenuToggleClick)
                        }
                    };
        ...
        VamtamActionLinksHandler: {
            ...
            popupActionLinks: function() {
                var _self = this,
                    ...
                    alignedPopups = [],
                    handleAlignWithParent = function(popupId, popupParent, clearPrevPos) {
                        ...
                        if (popup.length && popupParent) {
                            ...
                            clearPrevPos ? $(popup).css({
                                ...
                                "none" === $(popupWrapper).css("display") && ($(popup).css({
                                    top: "",
                                    left: ""
                    ...
                    repositionAlignedPopups = function(clear) {
                        alignedPopups.forEach((function(popup) {
                            clear ? handleAlignWithParent(popup.id, popup.parent, !0) : handleAlignWithParent(popup.id, popup.parent)
                        }))
                    },
                    popupResizeHandler = function() {
                        var isBelowMax = window.VAMTAM.isBelowMaxDeviceWidth();
                        prevIsBelowMax !== isBelowMax ? (isBelowMax ? repositionAlignedPopups(!0) : repositionAlignedPopups(), prevIsBelowMax = isBelowMax) : isBelowMax || repositionAlignedPopups()
                    },
                    popupScrollHandler = function() {
                    ...
                    storePopup = function(popupId, popupParent) {
                        var done;
                        alignedPopups.forEach((function(popup) {
                            popup.id === popupId && (popup.parent = popupParent, done = !0)
                        })), done || alignedPopups.push({
                            id: popupId,
                            parent: popupParent
                        })
                    };
                ...
                function checkForStickyParent(popupParent) {
                    ...
                    hasStickyParent && (window.removeEventListener("scroll", popupScrollHandler), window.addEventListener("scroll", popupScrollHandler, {
                        passive: !0
                    }))
                }
                var checkAlignWithParent = function(e) {
                    ...
                    if (actionLink) {
                        ...
                        settings && settings.align_with_parent && (storePopup(settings.id, e.currentTarget), window.VAMTAM.isMaxDeviceWidth() && handleAlignWithParent(settings.id, e.currentTarget), window.removeEventListener("resize", popupResizeHandler), window.addEventListener("resize", popupResizeHandler, !1), checkForStickyParent(e.currentTarget))
                    }
                };
                ...
                getSettingsFromActionLink: function(url) {
                    if (url = decodeURIComponent(url)) {
                        var settingsMatch = url.match(/settings=(.+)/),
                            settings = {};
                        return settingsMatch && (settings = JSON.parse(atob(settingsMatch[1]))), settings
                    }
                },
        ...
        VamtamWidgetsHandler: {
            stickyInsideParentFix: () => {
                ...
                stickyInsideElements.length && stickyInsideElements.forEach(element => {
            ...
            isWidgetModActive: widgetName => {
                ...
                return !!widgetModsList[widgetName] && ("yes" === siteSettings.vamtam_theme_enable_all_widget_mods || "yes" !== siteSettings.vamtam_theme_disable_all_widget_mods && "yes" === siteSettings[`vamtam_theme_${widgetName}`])
            }
        },
        VamtamImprovedCSSLoadingHandler: {
            init: () => {
                const widgetData = { ...VAMTAM_FRONT.widgets_assets_data
                };
                if (!widgetData) return;
                $("#vamtam-all-js-after").remove(), delete VAMTAM_FRONT.widgets_assets_data;
                let out = "";
                Object.keys(widgetData).forEach(widget => {
                    ...
                    if (content) {
                        if ($(`${widgetSelector} > style, ${widgetSelector} > link`).length) return;
                        out = out + "\r\n" + content
                    }
                }), out && $("body").append(`<div id="vamtam-css-opt-fallback">${out}</div>`)
            }
        },
        WidgetsObserver: {
            observer: null,
            targetsMap: new Map,
            init() {
                this.observer || (this.observer = new IntersectionObserver(this.handleIntersect.bind(this), {
                    root: null,
                    threshold: 0,
                    rootMargin: "0px"
                }))
            },
            observe(target, onIntersect, options = {
                once: !0
            }) {
                this.init(), this.targetsMap.has(target) || (this.targetsMap.set(target, {
                    onIntersect: onIntersect,
                    options: options
                }), this.observer.observe(target))
            },
            unobserve(target) {
                this.targetsMap.has(target) && (this.targetsMap.delete(target), this.observer.unobserve(target))
            },
                ...
                entries.forEach(entry => {
                    if (this.targetsMap.has(entry.target)) {
                        const {
                            onIntersect: onIntersect,
                            options: options
                        } = this.targetsMap.get(entry.target);
                        entry.isIntersecting && (onIntersect(), options.once && this.unobserve(entry.target))
                    }
                })
            }
        },
        WidgetsResizeObserver: {
            ...
            targetsMap: new Map,
            init() {
                this.observer || (this.observer = new ResizeObserver(this.handleResize.bind(this)))
            },
    ...
    window.VAMTAM_FRONT.elementor.urlActions = VAMTAM_ELEMENTOR.VamtamActionLinksHandler.utils, window.VAMTAM_FRONT.elementor.popups = VAMTAM_ELEMENTOR.VamtamPopupsHandler.utils, window.VAMTAM_FRONT.elementor.widgets = {
        isWidgetModActive: VAMTAM_ELEMENTOR.VamtamWidgetsHandler.isWidgetModActive
    }, window.VAMTAM_FRONT.WidgetsObserver = VAMTAM_ELEMENTOR.WidgetsObserver, window.VAMTAM_FRONT.WidgetsResizeObserver = VAMTAM_ELEMENTOR.WidgetsResizeObserver, $(document).ready((function() {
    ...
    class VamtamElementBase extends elementorModules.frontend.handlers.Base {
        onInit(...args) {
            super.onInit(...args), this.checkAddBaseThemeStylesClass()
        }
        checkAddBaseThemeStylesClass() {
            const isEditor = $("body").hasClass("elementor-editor-active");
            isEditor && this.isWidgetModActive() && this.$element.addClass("vamtam-has-theme-widget-styles")
        }
        isWidgetModActive() {
            let widgetName = this.getElementType();
            return "widget" === widgetName && (widgetName = this.getWidgetType()), VAMTAM_ELEMENTOR.VamtamWidgetsHandler.isWidgetModActive(widgetName)
        }
    }
    ...
    function overrideInitializeStickyAndAnchorTrackingMethod() {
        function initializeStickyAndAnchorTracking() {
            const anchorLinks = this.getAllAnchorLinks(),
                stickyElements = this.getAllStickyElements(),
                trackedElements = [];
            !stickyElements.length > 0 && !anchorLinks.length > 0 || (this.trackStickyElements(stickyElements, trackedElements), this.trackAnchorLinks(anchorLinks, trackedElements), this.organizeStickyAndAnchors(trackedElements), anchorLinks.forEach(link => {
                link.addEventListener("click", e => {
                    ...
                    if (target) {
                        ...
                        adminBar && (scrollTop -= adminBar.offsetHeight);
                        const maxStickyHeight = Math.max(0, ...stickyElements.map(el => el.offsetHeight));
                        scrollTop -= maxStickyHeight, window.scrollTo({
                            top: scrollTop,
                            behavior: "smooth"
                        })
                    }
    ...
    jQuery(window).on("elementor/frontend/init", () => {
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/global", addHandler), elementorFrontend.on("components:init", overrideInitializeStickyAndAnchorTrackingMethod)
    })
}(jQuery);